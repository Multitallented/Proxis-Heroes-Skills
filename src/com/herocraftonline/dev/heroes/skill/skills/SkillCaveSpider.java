...
public class SkillCaveSpider extends ActiveSkill {
    public SkillCaveSpider(Heroes plugin) {
        super(plugin, "CaveSpider");
        setDescription("$1% chance to spawn 1 cavespider, $2% for 2, and $3% for 3.");
        setUsage("/skill cavespider");
        setArgumentRange(0, 0);
        setIdentifiers(new String[]{"skill cavespider"});
