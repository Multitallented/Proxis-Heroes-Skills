...
public class SkillChaser extends TargettedSkill {
    ...
    public void init() {
        super.init();
        applyText = SkillConfigManager.getUseSetting(null, this, SkillSetting.APPLY_TEXT.node(), "%hero% makes the ground under %target%s feet hot!!").replace("%target%", "$1").replace("%hero%", "$2");
