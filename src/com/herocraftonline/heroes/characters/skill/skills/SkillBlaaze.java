...
public class SkillBlaaze extends ActiveSkill {
    public SkillBlaaze(Heroes plugin) {
        super(plugin, "Blaaze");
        setDescription("$1% chance to spawn 1 blaaze, $2% for 2, and $3% for 3.");
        setUsage("/skill blaaze");
        setArgumentRange(0, 0);
        setIdentifiers(new String[]{"skill blaaze"});
