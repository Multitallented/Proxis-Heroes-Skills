...
public class SkillMooshroom extends ActiveSkill {
    public SkillMooshroom(Heroes plugin) {
        super(plugin, "Mooshroom");
        setDescription("$1% chance to spawn 1 mooshroom, $2% for 2, and $3% for 3.");
        setUsage("/skill mooshroom");
        setArgumentRange(0, 0);
        setIdentifiers(new String[]{"skill mooshroom"});
